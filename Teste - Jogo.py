...
while x == sim:
        baseDados= {'Nome': ['Pedro', 'Paulo', 'Jose', 'Henrique', 'Daniel', 'Marcelo', 'Antonio', 'Claudio', 'Alexandre', 'Bruna', 'Luisa', 'Simone', 'Eliana'],
                    ...
                    'País':['Albania', 'Argentina', 'Catar', 'Bahamas', 'Colombia', 'França', 'Alemanha', 'Italia', 'Brasil']}
        ...
        if valor_roleta != "PASSA A VEZ" and valor_roleta != "PERDE TUDO":
            print("Valendo:R${}".format(valor_roleta))
        ...
        while ''.join(lacunas1) != pala1 or ''.join(lacunas2) != pala2 or ''.join(lacunas3) != pala3:
                if valor_roleta != "PASSA A VEZ" and valor_roleta != "PERDE TUDO":
                        ...
                        print("+================================================")
                        print("|ANA - {}| BARBARA - {}| CARLOS - {}".format(pontuacao[0],pontuacao[1],pontuacao[2]))
                        print("+================================================")
                        print("Vez do jogador: {}\nPontuação atual: {}\nRoleta: {}\nPontuação atualizada: ".format(jogadores[indice],pontuacao[indice],valor_roleta))
                        print("+================================================")
